...
def main(dataset, algorithm, model, batch_size, learning_rate, finetune_learning_rate, beta, lamda, num_global_warm_iters ,num_glob_iters,
    ...
    for i in range(times):
        ...
        # update learning rate and trainable
        server.num_glob_iters = num_glob_iters
        server.make_model_trainable()
        server.update_lr(learning_rate = finetune_learning_rate)
        server.train(start_iter=num_global_warm_iters)
